...
import PdfToJpgFaq from '../../../components/tools/PdfToJpgFaq';
import { PDF_TO_JPG_FAQS } from '../../../components/tools/pdfToJpgData';
import { getPdfToJpgCMS } from '../../../lib/api';
import {
  FileText,
  Shield,
  Zap,
...
export default async function PdfToJpgPage() {
  ...
  const activeFaqs = cms?.faqs && cms.faqs.length > 0 ? cms.faqs : PDF_TO_JPG_FAQS;
          ...
          <section className="mb-20 max-w-4xl mx-auto">
            <div className="text-center mb-10">
              <h2 className="text-2xl sm:text-3xl font-bold text-white mb-3">
                {cms?.how_it_works_title || 'How to Convert PDF to JPG in 3 Easy Steps'}
              </h2>
          ...
          <section className="mb-20 max-w-4xl mx-auto">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-bold text-white mb-2">
                {cms?.comparison_title || 'Axom AI vs. Traditional PDF to JPG Converters'}
              </h2>
