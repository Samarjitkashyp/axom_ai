...
urlpatterns = [
    ...
    path('sitemap-pages.xml', views.sitemap_pages_xml_view, name='sitemap_pages'),
    path('sitemap-blog.xml', views.sitemap_blog_xml_view, name='sitemap_blog'),
    path('sitemap-tools.xml', views.sitemap_tools_xml_view, name='sitemap_tools'),
