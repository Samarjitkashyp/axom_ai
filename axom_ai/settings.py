"""
Django settings for axom_ai project.
...
WSGI_APPLICATION = 'axom_ai.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'axom_ai'),
...
# Where `collectstatic` gathers files for production (served by WhiteNoise).
...
# When DEBUG is off, trust the Lightsail host/IP for CSRF over http.
if not DEBUG:
