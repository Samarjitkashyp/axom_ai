...
def save_hero_api(request):
    try:
        ...
        hero.entity_badge_text = data.get('entity_badge_text', hero.entity_badge_text)
        hero.entity_verified_text = data.get('entity_verified_text', hero.entity_verified_text)
        hero.entity_heading = data.get('entity_heading', hero.entity_heading)
        hero.entity_description = data.get('entity_description', hero.entity_description)
        hero.entity_attr1_label = data.get('entity_attr1_label', hero.entity_attr1_label)
        hero.entity_attr1_value = data.get('entity_attr1_value', hero.entity_attr1_value)
        hero.entity_attr2_label = data.get('entity_attr2_label', hero.entity_attr2_label)
        hero.entity_attr2_value = data.get('entity_attr2_value', hero.entity_attr2_value)
        hero.entity_attr3_label = data.get('entity_attr3_label', hero.entity_attr3_label)
        hero.entity_attr3_value = data.get('entity_attr3_value', hero.entity_attr3_value)
        hero.entity_attr4_label = data.get('entity_attr4_label', hero.entity_attr4_label)
        hero.entity_attr4_value = data.get('entity_attr4_value', hero.entity_attr4_value)
        if 'entity_section_active' in data:
            hero.entity_section_active = bool(data.get('entity_section_active'))
